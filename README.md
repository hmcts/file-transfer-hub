...
- Prod: Terraform does not generate the FTPS login secrets, storage-target secrets, BAIS target secrets, or certificate secrets. They must be created in Key Vault before the container-app deployment is planned or applied.
