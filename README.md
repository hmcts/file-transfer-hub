...
- `ftps-leds-notification-from-email`: `From` and `Reply-To` address on the notification email — must be on a domain authenticated with the SendGrid `platops` account
